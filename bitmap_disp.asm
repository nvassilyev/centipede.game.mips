.data
	...
	centipedLocation: .word 0:10
	centipedDirection: .word 0:10
.globl main
.text
main:
...
#function to draw mushroom
	bge  $t1, 3325, return	# i < 40
